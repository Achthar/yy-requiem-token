...
async function main(): Promise<void> {
    ...
    try {
        await dai['setMinter(address,uint256)']('0x10E38dFfFCfdBaaf590D5A9958B01C9cfcF6A63B', 10000000);
        await usdt['setMinter(address,uint256)']('0x10E38dFfFCfdBaaf590D5A9958B01C9cfcF6A63B', 10000000);
    } catch (e) { 
        console.log(e) 
    }
